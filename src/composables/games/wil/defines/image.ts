...
export const WIL_IMAGE_DEFINES: { [key: string]: string } = {
  ...
  // キャラクター（ミニマム）
  MINI_CHARACTER_HERO: WIL_IMAGE_ROOT_PATH + "characters/dots/hero.png",
  MINI_CHARACTER_HOLY_KNIGHTS_LEADER:
    WIL_IMAGE_ROOT_PATH + "characters/dots/holy_knights_leader.png",
  MINI_CHARACTER_HOLY_KNIGHTS_SOLDIER:
    WIL_IMAGE_ROOT_PATH + "characters/dots/holy_knights_soldier.png",
  MINI_CHARACTER_HOLY_KNIGHTS_MAGICIAN:
    WIL_IMAGE_ROOT_PATH + "characters/dots/holy_knights_magician.png",
  MINI_DARK_MONSTER_SHADOW:
