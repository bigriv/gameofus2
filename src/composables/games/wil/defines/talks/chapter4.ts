...
export const WIL_TALK_DEFINES_CHPATER4: Array<WilTalkDefine> = [
  [
    ...
    },
    {
      ...
      talker: "魔導兵",
      message: [
        "なんだ、嫉妬か？ついこの間まで先輩風吹かせてた相手が上司になったら複雑な気持ちにもなるわな。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
    ...
    },
    {
      ...
      talker: "ヒカル",
      message: [
        "その代理の王が言うには、魔物のあらわれるタイミングあまりにも良かったことから、焔の国が魔物を使役しているのではないかと。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
    ...
    },
    {
      ...
      talker: "ヒカル",
      message: [
        "一応、当初の目的である嵐の国との同盟は締結できたのですが、焔の国側の戦力もかなり大きくなっていることが分かりました。報告としては以上です。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
    ...
    },
    {
      ...
      talker: "皇帝",
      message: [
        "その隙に魔王の一部を盗み出した可能性が高い。そうなると、金の国の物と合わせると半分以上が焔の国に集まっていることとなる。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
    ...
    },
    {
      ...
      talker: "ジョット",
      message: [
        "同盟を締結して、挨拶なしってのは失礼だろ。それと、今言った通り、かなりまずい状況になってるってことを伝えにな。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
    ...
    },
    {
      ...
      talker: "ヒカル",
      message: [
        "嵐の国で管理していた魔王の一部も盗まれたと仮定すると、残ってるは氷の国...。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
    ...
    },
    {
      ...
      right: WIL_IMAGE_ID.CHARACTER_HOLY_LAND_EMPEROR,
      talker: "ヒカル",
      message: ["でも、聖騎士隊長は皇帝のもとを離れるわけには..."],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
      left: WIL_IMAGE_ID.CHARACTER_HERO,
      right: WIL_IMAGE_ID.CHARACTER_HOLY_LAND_EMPEROR,
      talker: "皇帝",
      message: ["今は一国よりも世界のことが優先だ。私もことより氷の国を頼む。"],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_TRAINING_ROOM,
      left: WIL_IMAGE_ID.CHARACTER_HERO,
    ...
    },
    {
      ...
      talker: "フロリア王",
      message: [
        "魔王の左腕は宝物子で管理しているんじゃが、その在りかは王族にしか伝えられておらんし、たやすく見つかるような場所にもない。仮に襲われて壊滅したとしても、盗まれることはまずあり得ない。",
      ],
    },
    {
      background: WIL_IMAGE_ID.BACKGROUND_ICE_LAND,
